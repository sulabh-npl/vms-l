...
#img-hh{
    background-image: url(/images/{{Session::get('uid')}}.jpg);
...
// $('.top-content').backstretch("/images/{{Session::get('uid')}}.jpg");
      ...
      <div class="sidebar-content">
        ...
        <div class="sidebar-header">
          ...
          <div class="user-info">
            ...
            <span class="user-name">{{Session::get('admin-name')}}
            </span>
            @endif
            <span class="user-role">
                @switch(Session::get('admin-per'))
                    @case(1)
                        Editor
                        @break
                    @case(2)
        ...
        <div class="sidebar-menu">
            <ul class="list-unstyled menu-elements">
                <li class="sidebar-dropdown">
                    <a class="" href="/admin"><i class="fas fa-home"></i> Home</a>
                </li>
                @if (Session::get('admin-per')!=2)
                <li>
                    <a class="" href="/admin/addVendor"><i class="fas fa-user"></i>Add Vendor</a>
                </li>
                <li>
                    <a class="" href="/admin/vendor_requests"><i class="fas fa-user"></i>Vendor Requests</a>
                </li>
                @endif
                <li>
                    <a class="" href="/admin/list"><i class="fas fa-user"></i>Manage Vendors</a>
                </li>
                @if (Session::get('admin-per')!=2)
                <li>
